...
export default function EndItemPage() {
  ...
  const [allEndItemHistory, setAllEndItemHistory] = useState([]);
            ...
            <CardContent>
              <Stack spacing={3}>
                          ...
                          control={
                            <Switch
                                ...
                                onChange={(e) => {
                                  ...
                                  setSeen(newSeen);
                                  postEndItemSeen(newSeen, "NA", new Date().toISOString(), "NA", currUser.id, id, selectedSerial?.serial_number);
                                }}
                                color="primary"
                            />
                          }
                ...
                <Button
                    ...
                    size="large"
                    fullWidth
                    onClick={() => navigate(`/equipment/${id}/inventory`)} // useParams to get the serial id
                >
